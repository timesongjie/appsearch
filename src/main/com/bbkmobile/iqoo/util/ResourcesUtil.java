...
public class ResourcesUtil {
    ...
    public static Properties getResourceAsProperties(String resource) throws IOException {
        ...
        return getPropertiesFromInputStream(in);
    }

    public static Properties getPropertiesFromInputStream(InputStream in) throws IOException {
