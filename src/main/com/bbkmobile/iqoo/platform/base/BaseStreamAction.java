...
public class BaseStreamAction extends BaseAction {
	...
	public void write(String content)throws IOException, Exception{
		write(content, null,0);
	}
	
	public void write(String content, String contentType)throws IOException, Exception{
		write(content, contentType,0);
	}
	
	public void write(String content,int code)throws IOException, Exception{
		write(content, null,code);
	}
	
	public void write(String content, String contentType,int code)throws IOException, Exception{
		Writer writer = null;
		try{
			if(code>0){
